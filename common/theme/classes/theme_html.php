...
class c_theme_html extends c_base_return {
  ...
  private static function s_p_populate_tag_class_names(&$tag, $type, $id) {
    ...
    else if ($type === c_base_markup_tag::TYPE_ABBR) {
      $class_1 = 'text';
      $class_2 = 'text-abbreviation';
    }
    else if ($type === c_base_markup_tag::TYPE_ADDRESS) {
      $class_1 = 'structure';
      $class_2 = 'structure-address';
    }
    else if ($type === c_base_markup_tag::TYPE_AREA) {
      $class_1 = 'datum';
      $class_2 = 'datum-area';
    }
    else if ($type === c_base_markup_tag::TYPE_ARTICLE) {
      $class_1 = 'structure';
    ...
    else if ($type === c_base_markup_tag::TYPE_AUDIO) {
      $class_1 = 'media';
      $class_2 = 'media-audio';
    }
    ...
    else if ($type === c_base_markup_tag::TYPE_BDI) {
      $class_1 = 'text';
      $class_2 = 'text-bdi';
      $class_3 = 'text-direction';
    }
    else if ($type === c_base_markup_tag::TYPE_BDO) {
      $class_1 = 'text';
      $class_2 = 'text-bdo';
      $class_3 = 'text-direction';
    }
    else if ($type === c_base_markup_tag::TYPE_BLOCKQUOTE) {
      $class_1 = 'text';
      $class_2 = 'text-blockquote';
      $class_3 = 'text-quote';
    }
    else if ($type === c_base_markup_tag::TYPE_BREAK) {
      $class_1 = 'structure';
      $class_2 = 'structure-break';
    }
    else if ($type === c_base_markup_tag::TYPE_BUTTON) {
      $class_1 = 'field';
      $class_2 = 'field-button';
    }
    else if ($type === c_base_markup_tag::TYPE_CANVAS) {
      $class_1 = 'structure';
      $class_2 = 'structure-canvas';
    }
    else if ($type === c_base_markup_tag::TYPE_CAPTION) {
      $class_1 = 'text';
      $class_2 = 'text-caption';
    }
    else if ($type === c_base_markup_tag::TYPE_CHECKBOX) {
      $class_1 = 'field';
      $class_2 = 'field-checkbox';
    }
    else if ($type === c_base_markup_tag::TYPE_CITE) {
      $class_1 = 'text';
      $class_2 = 'text-cite';
    }
    else if ($type === c_base_markup_tag::TYPE_CODE) {
      $class_1 = 'text';
      $class_2 = 'text-code';
    }
    else if ($type === c_base_markup_tag::TYPE_COLUMN) {
      $class_1 = 'structure';
      $class_2 = 'structure-column';
    }
    else if ($type === c_base_markup_tag::TYPE_COLOR) {
      $class_1 = 'field';
      $class_2 = 'field-color';
    }
    else if ($type === c_base_markup_tag::TYPE_COLUMN_GROUP) {
      $class_1 = 'structure';
      $class_2 = 'structure-column_group';
    }
    else if ($type === c_base_markup_tag::TYPE_DATA) {
      $class_1 = 'datum';
      $class_2 = 'datum-data';
    }
    else if ($type === c_base_markup_tag::TYPE_DATA) {
    ...
    else if ($type === c_base_markup_tag::TYPE_DATE) {
      $class_1 = 'field';
      $class_2 = 'field-date';
    }
    else if ($type === c_base_markup_tag::TYPE_DATE_TIME_LOCAL) {
      $class_1 = 'field';
      $class_2 = 'field-date_local_time';
    }
    else if ($type === c_base_markup_tag::TYPE_TERM_DESCRIPTION) {
      $class_1 = 'text';
      $class_2 = 'text-term_description';
    }
    else if ($type === c_base_markup_tag::TYPE_DEL) {
      $class_1 = 'format';
      $class_2 = 'format-delete';
    }
    else if ($type === c_base_markup_tag::TYPE_DETAILS) {
      $class_1 = 'structure';
      $class_2 = 'structure-details';
    }
    else if ($type === c_base_markup_tag::TYPE_DFN) {
      $class_1 = 'text';
      $class_2 = 'text-definition';
    }
    else if ($type === c_base_markup_tag::TYPE_DIALOG) {
      $class_1 = 'structure';
    ...
    else if ($type === c_base_markup_tag::TYPE_DEFINITION_LIST) {
      $class_1 = 'structure';
    ...
    else if ($type === c_base_markup_tag::TYPE_EMAIL) {
      $class_1 = 'field';
      $class_2 = 'field-email';
    }
    else if ($type === c_base_markup_tag::TYPE_EMBED) {
      $class_1 = 'media';
      $class_2 = 'media-embed';
    }
    else if ($type === c_base_markup_tag::TYPE_FIELD_SET) {
      $class_1 = 'structure';
      $class_2 = 'structure-field_set';
    }
    else if ($type === c_base_markup_tag::TYPE_FIGURE) {
      $class_1 = 'structure';
      $class_2 = 'structure-figure';
    }
    else if ($type === c_base_markup_tag::TYPE_FIGURE_CAPTION) {
      $class_1 = 'text';
      $class_2 = 'text-figure_caption';
      $class_3 = 'text-caption';
    }
    else if ($type === c_base_markup_tag::TYPE_FILE) {
      $class_1 = 'field';
      $class_2 = 'field-file';
    }
    ...
    else if ($type === c_base_markup_tag::TYPE_FORM) {
      $class_1 = 'structure';
      $class_2 = 'structure-form';
    }
    else if ($type === c_base_markup_tag::TYPE_H1) {
      $class_1 = 'text';
      $class_2 = 'text-heading';
      $class_3 = 'text-heading_1';
    }
    else if ($type === c_base_markup_tag::TYPE_H2) {
      $class_1 = 'text';
      $class_2 = 'text-heading';
      $class_3 = 'text-heading_2';
    }
    else if ($type === c_base_markup_tag::TYPE_H3) {
      $class_1 = 'text';
      $class_2 = 'text-heading';
      $class_3 = 'text-heading_3';
    }
    else if ($type === c_base_markup_tag::TYPE_H4) {
      $class_1 = 'text';
      $class_2 = 'text-heading';
    ...
    else if ($type === c_base_markup_tag::TYPE_H6) {
      $class_1 = 'text';
      $class_2 = 'text-heading';
      $class_3 = 'text-heading_6';
    }
    else if ($type === c_base_markup_tag::TYPE_HX) {
      $class_1 = 'text';
      $class_2 = 'text-heading';
    }
    else if ($type === c_base_markup_tag::TYPE_HEADER) {
      $class_1 = 'structure';
      $class_2 = 'structure-header';
    }
    else if ($type === c_base_markup_tag::TYPE_HIDDEN) {
      $class_1 = 'field';
      $class_2 = 'field-hidden';
    }
    else if ($type === c_base_markup_tag::TYPE_HORIZONTAL_RULER) {
      $class_1 = 'structure';
      $class_2 = 'structure-horizontal_ruler';
    }
    else if ($type === c_base_markup_tag::TYPE_ITALICS) {
      $class_1 = 'format';
      $class_2 = 'format-emphasis';
    }
    else if ($type === c_base_markup_tag::TYPE_HORIZONTAL_RULER) {
    ...
    else if ($type === c_base_markup_tag::TYPE_INLINE_FRAME) {
      $class_1 = 'structure';
      $class_2 = 'structure-inline_frame';
    }
    else if ($type === c_base_markup_tag::TYPE_IMAGE) {
      $class_1 = 'media';
      $class_2 = 'media-image';
    }
    else if ($type === c_base_markup_tag::TYPE_INPUT) {
      $class_1 = 'field';
      $class_2 = 'field-input';
    }
    else if ($type === c_base_markup_tag::TYPE_INS) {
      $class_1 = 'text';
      $class_2 = 'text-insert';
    }
    else if ($type === c_base_markup_tag::TYPE_KEYBOARD) {
      $class_1 = 'text';
      $class_2 = 'text-keyboard';
    }
    else if ($type === c_base_markup_tag::TYPE_KEY_GEN) {
      $class_1 = 'field';
    ...
    else if ($type === c_base_markup_tag::TYPE_LEGEND) {
      $class_1 = 'text';
      $class_2 = 'text-legend';
    }
    else if ($type === c_base_markup_tag::TYPE_LIST_ITEM) {
      $class_1 = 'text';
      $class_2 = 'text-list_item';
    }
    else if ($type === c_base_markup_tag::TYPE_MAIN) {
      $class_1 = 'structure';
      $class_2 = 'structure-main';
    }
    else if ($type === c_base_markup_tag::TYPE_MAP) {
      $class_1 = 'structure';
      $class_2 = 'structure-image_map';
    }
    else if ($type === c_base_markup_tag::TYPE_MARK) {
      $class_1 = 'format';
      $class_2 = 'format-mark';
    }
    else if ($type === c_base_markup_tag::TYPE_MENU) {
      $class_1 = 'structure';
      $class_2 = 'structure-menu';
    }
    else if ($type === c_base_markup_tag::TYPE_MENU_ITEM) {
      $class_1 = 'structure';
      $class_2 = 'structure-menu_item';
    }
    else if ($type === c_base_markup_tag::TYPE_METER) {
      $class_1 = 'field';
      $class_2 = 'field-meter';
    }
    else if ($type === c_base_markup_tag::TYPE_MONTH) {
      $class_1 = 'field';
      $class_2 = 'field-month';
    }
    else if ($type === c_base_markup_tag::TYPE_NAVIGATION) {
      $class_1 = 'structure';
      $class_2 = 'structure-navigation';
    }
    else if ($type === c_base_markup_tag::TYPE_NO_SCRIPT) {
      $class_1 = 'structure';
    ...
    else if ($type === c_base_markup_tag::TYPE_OBJECT) {
      $class_1 = 'media';
      $class_2 = 'media-object';
    }
    else if ($type === c_base_markup_tag::TYPE_ORDERED_LIST) {
      $class_1 = 'structure';
      $class_2 = 'structure-ordered_list';
    }
    else if ($type === c_base_markup_tag::TYPE_OPTIONS_GROUP) {
      $class_1 = 'structure';
      $class_2 = 'structure-options_group';
    }
    else if ($type === c_base_markup_tag::TYPE_OPTION) {
      $class_1 = 'datum';
      $class_2 = 'datum-option';
    }
    else if ($type === c_base_markup_tag::TYPE_OUTPUT) {
      $class_1 = 'datum';
      $class_2 = 'datum-output';
    }
    else if ($type === c_base_markup_tag::TYPE_PARAGRAPH) {
      $class_1 = 'text';
      $class_2 = 'text-paragraph';
    }
    else if ($type === c_base_markup_tag::TYPE_PARAM) {
      $class_1 = 'datum';
      $class_2 = 'datum-parameter';
    }
    else if ($type === c_base_markup_tag::TYPE_PASSWORD) {
      $class_1 = 'field';
      $class_2 = 'field-password';
    }
    else if ($type === c_base_markup_tag::TYPE_PICTURE) {
      $class_1 = 'structure';
      $class_2 = 'structure-picture';
    }
    else if ($type === c_base_markup_tag::TYPE_PREFORMATTED) {
      $class_1 = 'format';
      $class_2 = 'format-preformatted';
    }
    else if ($type === c_base_markup_tag::TYPE_PROGRESS) {
    ...
    else if ($type === c_base_markup_tag::TYPE_QUOTE) {
      $class_1 = 'text';
      $class_2 = 'text-quote';
    }
    else if ($type === c_base_markup_tag::TYPE_RADIO) {
      $class_1 = 'field';
      $class_2 = 'field-radio';
    }
    else if ($type === c_base_markup_tag::TYPE_RANGE) {
      $class_1 = 'field';
      $class_2 = 'field-range';
    }
    else if ($type === c_base_markup_tag::TYPE_RESET) {
      $class_1 = 'field';
      $class_2 = 'field-reset';
    }
    else if ($type === c_base_markup_tag::TYPE_RUBY_PARENTHESIS) {
      $class_1 = 'format';
      $class_2 = 'format-ruby_parenthesis';
    }
    else if ($type === c_base_markup_tag::TYPE_RUBY_PRONUNCIATION) {
      $class_1 = 'format';
    ...
    else if ($type === c_base_markup_tag::TYPE_SAMPLE) {
      $class_1 = 'text';
      $class_2 = 'text-sample';
    }
    else if ($type === c_base_markup_tag::TYPE_SEARCH) {
      $class_1 = 'field';
    ...
    else if ($type === c_base_markup_tag::TYPE_SMALL) {
      $class_1 = 'format';
      $class_2 = 'format-small';
    }
    else if ($type === c_base_markup_tag::TYPE_SOURCE) {
      $class_1 = 'datum';
      $class_2 = 'datum-source';
    }
    else if ($type === c_base_markup_tag::TYPE_SPAN) {
      $class_1 = 'structure';
      $class_2 = 'structure-span';
    }
    else if ($type === c_base_markup_tag::TYPE_STRONG) {
      $class_1 = 'format';
      $class_2 = 'format-strong';
    }
    else if ($type === c_base_markup_tag::TYPE_SUB_SCRIPT) {
      $class_1 = 'format';
      $class_2 = 'format-sub_script';
    }
    else if ($type === c_base_markup_tag::TYPE_SUBMIT) {
      $class_1 = 'field';
      $class_2 = 'field-submit';
    }
    else if ($type === c_base_markup_tag::TYPE_SUPER_SCRIPT) {
      $class_1 = 'format';
      $class_2 = 'format-super_script';
    }
    else if ($type === c_base_markup_tag::TYPE_SVG) {
      $class_1 = 'media';
      $class_2 = 'media-svg';
    }
    else if ($type === c_base_markup_tag::TYPE_TABLE) {
      $class_1 = 'structure';
      $class_2 = 'structure-table';
    }
    else if ($type === c_base_markup_tag::TYPE_TABLE_BODY) {
      $class_1 = 'structure';
      $class_2 = 'structure-table_body';
    }
    else if ($type === c_base_markup_tag::TYPE_TABLE_CELL) {
      $class_1 = 'structure';
    ...
    else if ($type === c_base_markup_tag::TYPE_TABLE_HEADER) {
      $class_1 = 'structure';
      $class_2 = 'structure-table_header';
    }
    else if ($type === c_base_markup_tag::TYPE_TABLE_HEADER_CELL) {
      $class_1 = 'structure';
      $class_2 = 'structure-table_header_cell';
    }
    else if ($type === c_base_markup_tag::TYPE_TABLE_ROW) {
      $class_1 = 'structure';
      $class_2 = 'structure-table_row';
    }
    else if ($type === c_base_markup_tag::TYPE_TELEPHONE) {
      $class_1 = 'field';
      $class_2 = 'field-telephone';
    }
    else if ($type === c_base_markup_tag::TYPE_TEMPLATE) {
      $class_1 = 'datum';
      $class_2 = 'datum-template';
    }
    else if ($type === c_base_markup_tag::TYPE_TEXT) {
      $class_1 = 'field';
      $class_2 = 'field-text';
    }
    else if ($type === c_base_markup_tag::TYPE_TEXT_AREA) {
      $class_1 = 'field';
      $class_2 = 'field-text_area';
    }
    else if ($type === c_base_markup_tag::TYPE_TIME) {
      $class_1 = 'field';
      $class_2 = 'field-time';
    }
    else if ($type === c_base_markup_tag::TYPE_TRACK) {
      $class_1 = 'datum';
      $class_2 = 'datum-track';
    }
    else if ($type === c_base_markup_tag::TYPE_UNDERLINE) {
      $class_1 = 'format';
      $class_2 = 'format-underline';
    }
    else if ($type === c_base_markup_tag::TYPE_UNORDERED_LIST) {
      $class_1 = 'structure';
      $class_2 = 'structure-unordered_list';
    }
    else if ($type === c_base_markup_tag::TYPE_URL) {
      $class_1 = 'text';
      $class_2 = 'text-url';
    }
    else if ($type === c_base_markup_tag::TYPE_VARIABLE) {
      $class_1 = 'text';
      $class_2 = 'text-variable';
    }
    else if ($type === c_base_markup_tag::TYPE_VIDEO) {
      $class_1 = 'media';
      $class_2 = 'media-video';
    }
    else if ($type === c_base_markup_tag::TYPE_WEEK) {
      $class_1 = 'field';
      $class_2 = 'field-week';
    }
    else if ($type === c_base_markup_tag::TYPE_WIDE_BREAK) {
      $class_1 = 'structure';
  ...
  private function p_render_markup_body_tags_by_type($tag, $type, $child_markup) {
    ...
    else if ($type === c_base_markup_tag::TYPE_ALTERNATE_GLYPH) {
    ...
    else if ($type === c_base_markup_tag::TYPE_ANIMATE_MOTION) {
    ...
    else if ($type === c_base_markup_tag::TYPE_ANIMATE_TRANSFORM) {
    ...
    else if ($type === c_base_markup_tag::TYPE_CIRCLE) {
    ...
    else if ($type === c_base_markup_tag::TYPE_CLIP_PATH) {
    ...
    else if ($type === c_base_markup_tag::TYPE_COLOR_PROFILE) {
    ...
    else if ($type === c_base_markup_tag::TYPE_CURSOR) {
    ...
    else if ($type === c_base_markup_tag::TYPE_DATA_LIST) {
    ...
    else if ($type === c_base_markup_tag::TYPE_DEFS) {
    ...
    else if ($type === c_base_markup_tag::TYPE_DESCRIPTION) {
    ...
    else if ($type === c_base_markup_tag::TYPE_ELLIPSE) {
    ...
    else if ($type === c_base_markup_tag::TYPE_FE_BLEND) {
    ...
    else if ($type === c_base_markup_tag::TYPE_GROUP) {
    ...
    else if ($type === c_base_markup_tag::TYPE_IMAGE_SVG) {
    ...
    else if ($type === c_base_markup_tag::TYPE_LINE) {
    ...
    else if ($type === c_base_markup_tag::TYPE_LINEAR_GRADIENT) {
    ...
    else if ($type === c_base_markup_tag::TYPE_PATH) {
    ...
    else if ($type === c_base_markup_tag::TYPE_PATTERN) {
    ...
    else if ($type === c_base_markup_tag::TYPE_POLYGON) {
    ...
    else if ($type === c_base_markup_tag::TYPE_POLYLINE) {
    ...
    else if ($type === c_base_markup_tag::TYPE_RADIAL_GRADIENT) {
    ...
    else if ($type === c_base_markup_tag::TYPE_RECTANGLE) {
    ...
    else if ($type === c_base_markup_tag::TYPE_STOP) {
    ...
    else if ($type === c_base_markup_tag::TYPE_USE) {
